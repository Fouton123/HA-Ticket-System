...
PRODID = "-//homeassistant.io//ticket_todo 2.0//EN"
PRODID_REQUIRES_MIGRATION = "-//homeassistant.io//ticket_todo 1.0//EN"
...
async def async_setup_entry(
    ...
    """Set up the ticket_todo todo platform."""
    ...
    entity = TicketTodoListEntity(store, calendar, name, unique_id=config_entry.entry_id)
...
class TicketTodoListEntity(TodoListEntity):
